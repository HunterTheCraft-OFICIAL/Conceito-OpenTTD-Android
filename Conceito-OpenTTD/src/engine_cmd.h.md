# 📄 src/engine_cmd.h - Tradução Conceitual

> **Nota:** Este é um documento conceitual em português do Brasil baseado no arquivo original `src/engine_cmd.h` do OpenTTD.
> 
...
- **Arquivo Original:** `src/engine_cmd.h`
