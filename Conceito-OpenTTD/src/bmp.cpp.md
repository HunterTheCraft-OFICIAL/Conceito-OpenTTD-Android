# 📄 src/bmp.cpp - Tradução Conceitual

> **Nota:** Este é um documento conceitual em português do Brasil baseado no arquivo original `src/bmp.cpp` do OpenTTD.
> 
