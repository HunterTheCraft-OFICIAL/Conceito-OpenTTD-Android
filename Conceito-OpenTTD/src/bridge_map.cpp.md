# 📄 src/bridge_map.cpp - Tradução Conceitual

> **Nota:** Este é um documento conceitual em português do Brasil baseado no arquivo original `src/bridge_map.cpp` do OpenTTD.
> 
...
/**
 * Finds the end of a bridge in the specified dir...
```
...
- **Arquivo Original:** `src/bridge_map.cpp`
