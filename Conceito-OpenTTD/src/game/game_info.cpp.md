# 📄 src/game/game_info.cpp - Tradução Conceitual

> **Nota:** Este é um documento conceitual em português do Brasil baseado no arquivo original `src/game/game_info.cpp` do OpenTTD.
> 
...
- **Arquivo Original:** `src/game/game_info.cpp`
