# 📄 src/game/game_core.cpp - Tradução Conceitual

> **Nota:** Este é um documento conceitual em português do Brasil baseado no arquivo original `src/game/game_core.cpp` do OpenTTD.
> 
...
- **Arquivo Original:** `src/game/game_core.cpp`
