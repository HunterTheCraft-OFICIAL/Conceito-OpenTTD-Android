# 📄 src/depot_base.h - Tradução Conceitual

> **Nota:** Este é um documento conceitual em português do Brasil baseado no arquivo original `src/depot_base.h` do OpenTTD.
> 
...
- **Arquivo Original:** `src/depot_base.h`
