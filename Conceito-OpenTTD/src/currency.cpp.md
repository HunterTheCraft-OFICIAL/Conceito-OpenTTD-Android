# 📄 src/currency.cpp - Tradução Conceitual

> **Nota:** Este é um documento conceitual em português do Brasil baseado no arquivo original `src/currency.cpp` do OpenTTD.
> 
...
- **Arquivo Original:** `src/currency.cpp`
