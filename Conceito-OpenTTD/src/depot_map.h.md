# 📄 src/depot_map.h - Tradução Conceitual

> **Nota:** Este é um documento conceitual em português do Brasil baseado no arquivo original `src/depot_map.h` do OpenTTD.
> 
...
- **Arquivo Original:** `src/depot_map.h`
