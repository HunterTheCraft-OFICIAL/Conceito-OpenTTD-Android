# 📄 src/cargo_type.h - Tradução Conceitual

> **Nota:** Este é um documento conceitual em português do Brasil baseado no arquivo original `src/cargo_type.h` do OpenTTD.
> 
...
- **Arquivo Original:** `src/cargo_type.h`
